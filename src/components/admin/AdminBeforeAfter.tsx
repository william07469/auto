  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-dashed border-border p-6">
        <p className="text-[0.6rem] uppercase tracking-[0.3em] text-muted-foreground mb-4">
          Neuer Vorher/Nachher Eintrag
        </p>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <Field
              label="Beschreibung (wird als Kategorie-Text angezeigt)"
      ...
      {visibleItems.length === 0 && (
        <Empty label={filterCategory === "Alle" ? "Noch keine Vorher/Nachher Einträge." : `Keine Einträge in „${filterCategory}".`} />
      )}
          ...
          return (
            <div key={it.id} className="rounded-2xl border border-border bg-card p-6">
              ...
              <div className="mb-4 flex items-center gap-3">
                <span className="inline-flex items-center rounded-full px-3 py-1 text-[0.6rem] font-medium uppercase tracking-[0.2em] bg-foreground/10 text-foreground ring-1 ring-foreground/20">
                  {it.category}
                </span>
