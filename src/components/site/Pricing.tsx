...
const FALLBACK_PLANS: Plan[] = [
  {
    ...
    tier: "Volle Außenrestaurierung & Schutz",
    price: { basic: 70, deluxe: 130 },
    duration: "",
    features: {
      basic: [
  ...
  },
  {
    ...
    tier: "Das Komplettpaket für die komplette Fahrzeugtransformation",
    price: { basic: 130, deluxe: 250 },
    duration: "",
    popular: true,
    features: {
      basic: [
  ...
  },
  {
    ...
    tier: "Tiefenreinigung & Aufbereitung Ihres Innenraums",
    price: { basic: 80, deluxe: 150 },
    duration: "",
    features: {
      basic: [
