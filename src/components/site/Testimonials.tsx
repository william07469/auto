...
const fallback: Review[] = [
  {
    id: "1",
    author: "Markus Weber",
    role: "Jeep Trackhawk Owner",
    content: "Absolute Perfektion. Mein weißer Trackhawk wurde wie ein Kunstwerk behandelt. Das Ergebnis hat alle meine Erwartungen übertroffen.",
    rating: 5,
  },
  {
    id: "2",
    author: "Sabrina Klein",
    role: "Jeep Trackhawk White Edition",
    content: "Von der Beratung bis zur Übergabe — jeder Schritt war professionell. Die Keramikversiegelung auf dem weißen Lack ist außergewöhnlich.",
    rating: 5,
  },
  {
    id: "3",
    author: "Thomas Richter",
    role: "Jeep Grand Cherokee Trackhawk",
    content: "Nach der Lackkorrektur sieht mein Trackhawk besser aus als am ersten Tag. Unglaubliche Handwerkskunst.",
    rating: 5,
  },
  {
    id: "4",
    author: "Julia Hoffmann",
    role: "Jeep Trackhawk Supercharged",
    content: "Vertrauen ist alles, wenn es um ein High-Performance-Fahrzeug wie den Trackhawk geht. WV Detailing hat dieses Vertrauen vollständig verdient.",
    rating: 5,
  },
];
